...
Range C1(ll s_, ll e_) {
    return Range{s_, e_, e_ - s_ + 1};
}
Range C2(ll s_, ll l_) {
    return Range{s_, s_ + l_ - 1, l_};
} 
...
bool is_combinable(const Range& r1, const Range& r2) {
    if (r1.e + 1 < r2.s or r2.e + 1 < r1.s)
        return false;
    return true;
}
bool is_intersect(const Range& r1, const Range& r2) {
    if (r1.e < r2.s or r2.e < r1.s)
        return false;
    return true;
}
...
vector<Range> operator-(const Range& r1, const Range& r2) {
    if (!is_intersect(r1, r2))
        return vector<Range>{r1};
    if (r2.s <= r1.s and r2.e >= r1.e)
        return vector<Range>();
    if (r2.s <= r1.s and r2.e < r1.e)
        return vector<Range>{C1(r2.e + 1, r1.e)};
    if (r2.s > r1.s and r2.e >= r1.e)
        return vector<Range>{C1(r1.s, r2.s - 1)};
